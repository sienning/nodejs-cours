...
(J'ai déjà fait du node.js.)

## Backend

Pour initialiser le backend, il faut lancer la commander `npm i` dans le dossier /backend .
Il faut également créer un dossier .env (cf .env.example) avec le nom de votre base de données.
Puis, entrer la commande `nodemon` pour démarrer le backend.
